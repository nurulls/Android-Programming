package com.example.todolistquiz.data.repository
...
class TodoRepository {
    ...
    suspend fun addTodo(userId: String, title: String, priority: String = "MEDIUM", category: String = "Kerja") {
        val todo = Todo(
            title = title,
            priority = priority,
            category = category
    ...
    suspend fun updateTodo(userId: String, todoId: String, newTitle: String, priority: String, category: String) {
